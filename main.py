...
wizard_sheet = pygame.image.load('assets/images/Wizards/wizard.png').convert_alpha()
...
while run: 
    ...
    #update count down 
    if intro_count <= 0:
        fighter_1.move(SCREEN_WIDTH, SCREEN_HEIGTH, screen, fighter_2, round_over)
        fighter_2.move(SCREEN_WIDTH, SCREEN_HEIGTH, screen, fighter_1, round_over)
    else:
        #deiplay count timer
        draw_text(str(intro_count), count_font, RED, SCREEN_WIDTH/2, SCREEN_HEIGTH/3)
        #update count timer
